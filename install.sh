...
EOF
  ...
  "${PUPPET_BIN_DIR?}/puppet" config set server krahulchowdary1.mylabserver.com --section main
...
#run_agent_install_from_url "https://krahulchowdary1.mylabserver.com:8140/packages/2016.2.1/${PLATFORM_TAG}.bash" "$@"
